...
function Contact(){
 return(
    ...
    <Box sx={{
     ...
     <Typography >
        <h3 class='responsive_fontsize24'>Quick Links</h3>
        <ul class='responsive_fontsize20'>
            <a href="#"><li>Home</li></a>
            <a href="#"><li>FAQs</li></a>
        ...
        <Typography >
        <h3 class='responsive_fontsize24'>Properties</h3>
        <ul class='responsive_fontsize20'>
        ...
        <Typography >
        <h3 class='responsive_fontsize24'>Contact Info</h3>
        <ul class='responsive_fontsize20'>
            <li>Kusunti 13</li>
