...
const Card = React.memo(function (props) {
  ...
  return (
    <Box
      sx={{
        // width: "500px",
        minWidth:{xs:"200px",sm:"350px",md:"500px"},
    ...
    >
      <LocationOnIcon className='responsive_fontsize26' sx={{position:"absolute",top:{xs:"66%",sm:"64%",md:"65%"},left:{xs:"6px",sm:"7px",md:"1%"},color:"#ffffff"}}/>
      <Typography sx={{position:"absolute",top:{xs:"65%",sm:"64%",md:"66%",},left:'1%',color:"#FFFFFF",marginLeft:"30px"}}variant='body2' color="textSecondary" component="p">{location}</Typography>
