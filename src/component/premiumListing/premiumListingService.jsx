...
function PremiumList() {
  ...
  return (
    <div className="center__carousel"
      style={{ display: "flex", flexDirection: "column", width: "100%", justifyContent: "space-evenly" }}
    >
     
      <Slider {...settings} >
        {PremiumListItems.map((item) => (
          // <div key={item.id} className="top-card-wrapper" style={{ padding: "0px", margin: "0px", width: "auto" }}>
            <PremiumCard
